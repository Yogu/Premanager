...
final class User extends Model {
	 ...
	 * @var string
	 */
	public $name = Module::PROPERTY_GET_SET;
	
	/**
	 * The title of the group with the highest priority
	 *
	 * Ths property is read-only.
	 * 
	 * @var string
	...
	/**
	 * The color of the group with the highest priority
	 *
	 * The color format is hexadecimal RRGGBB.
	 *
	 * Ths property is read-only.
	 * 
	 * @var string
	...
	/**
	 * Specifies wheater this user has an avatar
	 *
	 * Ths property is read-only.
	 * 
	 * @var bool
	 */      
	public $hasAvatar = Module::PROPERTY_GET;    
	 
	/**
	 * The mime type of the avatar, if exists.
	 *
	 * Ths property is read-only.
	 * 
	 * @var string
	 */   
	public $avatarMIME = Module::PROPERTY_GET;    
	 
	/**
	 * The status of this user (Premanager\Models\UserStatus enum)
	 *
	 * UserStatus::WAIT_FOR_EMAIL can only be used if there is an unconfirmed
	 * email address set for this user.
	 * 
	 * @var int
	 */   
	public $status = Module::PROPERTY_GET_SET;       
	 
	/**
	 * Specifies wheater this user is a bot
	 *
	 * @see setBotValues   
	 *
	 * Ths property is read-only.
	 ...
	 * @var bool
	 */   
	public $isBot = Module::PROPERTY_GET;           
	 
	/**
	 * A regular expression that matches on the bot's user agent 
	 *
	 * Ths property is read-only.   
	 *
	 * @see setBotValues  
	 ...
	 * @var string
	 */   
	public $botIdentifier = Module::PROPERTY_GET;           
	 
	/**
	 * Specifies wheater there is a personal sidebar for this user.
	 *
	 * Ths property is read-only.
	 * 
	 * @var string
	 */   
	public $hasPersonalSidebar = Module::PROPERTY_GET;             
	 ...
	 * @var string
	 */   
	public $email = Module::PROPERTY_GET_SET;                 
	 ...
	 * Ths property is read-only.  
	 *
	 * @see setUnconfirmedEmail()
	 * @see removeUnconfirmedEmail()
	 * @see confirmUnconfirmedEmail()
	 * 
	 * @var string
	 */     
	public $unconfirmedEmail = Module::PROPERTY_GET;              
	 
	/**
	 * If there is an unconfirmed email address, provides the time this was set    
	 *
	 * Ths property is read-only.
	 *
	 * @see setUnconfirmedEmail()
	 ...
	 */     
	public $unconfirmedEmailStartTime = Module::PROPERTY_GET;           
	 
	/**
	 * If there is an unconfirmed email address, provides a key that is needed to
	 * confirm it               
	 *
	 * Ths property is read-only.                 
	 *
	...
	/**
	 * Specifies if there is a secondary password for this user
	 *
	 * Ths property is read-only.
	 *
	 * @see setSecondaryPassword()
	 * 
	 * @var bool
	 */       
	public $hasSecondaryPassword = Module::PROPERTY_GET;           
	 
	/**
	 * If there is a secondary password, provides the time that was set
	 *
	 * Ths property is read-only.
	 *
	 * @see setSecondaryPassword()
	 ...
	 * @var Premanager\DateTime
	 */       
	public $secondaryPasswordStartTime = Module::PROPERTY_GET;          
	 
	/**
	 * If there is a secondary password, provides the time that expires
	 *
	 * Ths property is read-only.
	 *
	 * @see setSecondaryPassword()
	 ...
	 * @var Premanager\DateTime
	 */       
	public $secondaryPasswordExpirationTime = Module::PROPERTY_GET;          
	 
	/**
	 * If there is a secondary password, provides the ip address from that that
	 * has been set
	 *
	 * Ths property is read-only.
	 *
	 ...
	 * @var string
	 */       
	public $secondaryPasswordStartIP = Module::PROPERTY_GET;             
	...
	public static function getDescriptor() {
		if (self::$_descriptor === null) {
			self::$_descriptor = new ModelDescriptor(__CLASS__, array(
				'id' => array(DataType::NUMBER, 'id'),
				'name' => array(DataType::STRING, 'name'),
				'title' => array(DataType::STRING, 'title'),
				'color' => array(DataType::STRING, 'color'),
				'hasAvatar' => array(DataType::BOOLEAN, 'hasAvatar'),
				'avatarMIME' => array(DataType::STRING, 'avatarMIME'),
				'status' => array(DataType::NUMBER, 'status'),
				'isBot' => array(DataType::BOOLEAN, 'isBot'),
				'botIdentifier' => array(DataType::STRING, 'botIdentifier'),
				'hasPersonalSidebar' => array(DataType::BOOLEAN, 'hasPersonalSidebar'),
				'email' => array(DataType::STRING, 'email'),
				'unconfirmedEmail' => array(DataType::STRING, 'unconfirmedEmail'),
				'unconfirmedEmailStartTime' =>
					array(DataType::STRING, 'unconfirmedEmailStartTime'),
				'unconfirmedEmailKey' => array(DataType::STRING, 'unconfirmedEmailKey'),
				'registrationTime' => array(DataType::DATE_TIME, 'registrationTime'),
				'registrationIP' => array(DataType::STRING, 'registrationIP'),
				'lastLoginTime' => array(DataType::DATE_TIME, 'lastLoginTime'),
				'lastLoginIP' => array(DataType::STRING, 'lastLoginIP'),
				'lastVisibleLoginTime' =>
					array(DataType::DATE_TIME, 'lastVisibleLoginTime'),
				'lastLoginTime' => array(DataType::DATE_TIME, 'lastLoginTime'),
				'lastVisibleLoginTime' =>
					array(DataType::DATE_TIME, 'lastVisibleLoginTime'),
				'hasSecondaryPassword' => DataType::BOOLEAN,
