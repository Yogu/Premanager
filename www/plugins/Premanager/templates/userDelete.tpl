...
{block "toolbar"}       
	{if ($Me_id && $Premanager_User_id == $Me_loggedIn) || $Me_right_Premanager_manageUsers || $Me_right_manageRights}
		<ul class="toolbar">                             
			{if $Me_right_Premanager_manageUsers}
				...
				{if $Premanager_User_id}
					<li><a href="./{treeURL Premanager Users}/{url $Premanager_User_name}?delete" class="tool-delete-user active" title="{string Premanager deleteUserDescription}">{string Premanager deleteUser}</a></li>
				{else}
