	...
	public static function getDescriptor() {
		if (self::$_descriptor === null) {
			self::$_descriptor = new ModelDescriptor(__CLASS__, array(
				...
				'hasAvatar' => DataType::BOOLEAN,
				'avatarMIME' => DataType::STRING,
				'status' => DataType::NUMBER,
				'isBot' => DataType::BOOLEAN,
				'botIdentifier' => DataType::STRING,
				'hasPersonalSidebar' => DataType::BOOLEAN,
				'email' => DataType::STRING,
				'unconfirmedEmail' => DataType::STRING,
				'unconfirmedEmailStartTime' => DataType::STRING,
				'unconfirmedEmailKey' => DataType::STRING,
				'registrationTime' => DataType::DATE_TIME,
				'registrationIP' => DataType::STRING,
				'lastLoginTime' => DataType::DATE_TIME,
				'lastLoginIP' => DataType::STRING,
				'lastVisibleLoginTime' => DataType::DATE_TIME,
