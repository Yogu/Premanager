...
class FileResponse extends Response {
	 ...
	 * @param int $disposition enum Premanager\Execution\FileDisposition
	 ...
	 */
	public function __construct($fileName, $displayFileName, $contentType,
		$disposition = FileDisposition::INLINE, $useCache = true, $code = 200)
	{
	...
	protected function sendHeaders() {
		...
		if ($this->_useCache) {
		  ...
		  if (!strpos(Strings::toLower((Request::getUserAgent())), 'msie 6.0')) {
		...
		switch ($this->_disposition) {
			case FileDisposition::ATTACHMENT:
